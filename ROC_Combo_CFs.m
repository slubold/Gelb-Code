...
for l = 1:nIter
    ...
    jmpFncCfs_1 = 1i * fHat_null .* sign(fourModes) .* cfac_t;
    jmpFncCfs_2 = 1i * fHat_null .* sign(fourModes) .* cfac_p;
    jmpFncCfs_3 = 1i * fHat_null .* sign(fourModes) .* cfac_t;
    ...
    jmpFncCfs_1 = 1i * fHat_alt .* sign(fourModes) .* cfac_t;
    jmpFncCfs_2 = 1i * fHat_alt .* sign(fourModes) .* cfac_p;
    jmpFncCfs_3 = 1i * fHat_alt .* sign(fourModes) .* cfac_t;
